...
(
    ...
    `before.price_for_amount_item` Nullable(Decimal(10,2)),
    `before.valid_hours` Nullable(Int32),
    `before.total_amount` Nullable(Decimal(10,3)),
    ...
    `after.price_for_amount_item` Nullable(Decimal(10,2)),
    `after.valid_hours` Nullable(Int32),
    `after.total_amount` Nullable(Decimal(10,3)),
...
(
    ...
    `before.amount` Nullable(Decimal(10,3)),
    `before.price` Nullable(Decimal(10,2)),

    `after.order_id` Nullable(UInt64),
    `after.product_id` Nullable(UInt64),
    `after.amount` Nullable(Decimal(10,3)),
    `after.price` Nullable(Decimal(10,2)),
