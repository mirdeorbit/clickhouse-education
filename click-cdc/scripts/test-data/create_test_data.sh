...
# ./exec_click.sh "
# INSERT INTO cdc.postgres_delivery_public_polygons
# (
#     \`before.id\`,
#     \`before.name\`,
#     \`before.city\`,
...
# ./exec_click.sh "
# INSERT INTO clients.delivery_polygons_events
# (
#     id,
#     name,
#     city,
...
#     'Saint Petersburg',
#     1,
#     toDateTime64(1772314664069 / 1000, 3),
#     1772314664167
# );
# " 0

# ./exec_postgres.sh "INSERT INTO polygons (name, city, is_active)
# VALUES
# ('Center Zone', 'Moscow', true),
# ('North Zone', 'Moscow', true),
# ('South Zone', 'Saint Petersburg', true);"

# ./exec_postgres.sh "INSERT INTO shops (address, delivery_enabled, start_work_time, end_work_time, city, polygon_id)
# VALUES
...
./exec_postgres.sh "INSERT INTO couriers (first_name, last_name, patronymic, phone, email, inn, city, status, company, self_employed, timezone, polygon_id)
VALUES
...
./exec_postgres.sh "INSERT INTO pickers (first_name, last_name, patronymic, phone, email, status, network,city, timezone, shop_id)
VALUES
...
# ./exec_postgres.sh "INSERT INTO products ( title, amount_type, price_for_amount_item, valid_hours, total_amount, discount_percent)
# VALUES
...
# ./exec_postgres.sh "INSERT INTO clients (id, full_name, phone, address)
# VALUES
...
./exec_postgres.sh "INSERT INTO orders (city, status, shop_id, client_id,picker_id, courier_id, payment, create_date, pay_date)
VALUES
...
# ./exec_postgres.sh "INSERT INTO order_products (order_id, product_id, amount, price)
# VALUES
# (1, 1, 1.500, 180.75),
# (1, 2, 2.000, 179.80),
# (2, 3, 3.000, 285.00),
...
# ./exec_postgres.sh "INSERT INTO work_shifts ( start_date, end_date, create_date, close_date, courier_id, status, close_reason)
# VALUES
